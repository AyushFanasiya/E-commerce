                            ...
                            return (
                                <div key={index}>
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        const { status } = order
                                        return (
                                            <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-black md:flex-row">
                                                {/* main 3  */}
                                                <div className="w-full border-r border-black bg-gray-50 md:max-w-xs">
                                                    {/* left  */}
                                                    <div className="p-8">
